...
type OrderItemColumns struct {
	...
	GoodsName     string // Goods name snapshot
	GoodsImageUrl string // Goods image snapshot
	PointsPrice   string // Points price snapshot
	Count         string // Goods count
	TotalPoints   string // Item total points
